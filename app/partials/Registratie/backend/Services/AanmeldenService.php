...
{
  public function addSpelerToToernooi($persoon_id, $toernooi_id, $team_naam, $partner_id) {
    ...
    $stmt->bindValue(2, $toernooi_id);
    $stmt->bindValue(3, $team_naam);
    $stmt->bindValue(4, $partner_id);
    $stmt->execute();
  }
}
